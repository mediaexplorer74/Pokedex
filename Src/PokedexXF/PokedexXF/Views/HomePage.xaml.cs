...
namespace PokedexXF.Views
{
    ...
    public partial class HomePage : ContentPage
    {
        ...
        {
            frameSearch.BackgroundColor = 
                (Color)Application.Current.Resources["ColorBackgroundPressedInput"];
        }

        private void CustomEntryBorderless_Unfocused(object sender, FocusEventArgs e)
        {
            frameSearch.BackgroundColor = 
                (Color)Application.Current.Resources["ColorBackgroundDefaultInput"];
        }
    }
}